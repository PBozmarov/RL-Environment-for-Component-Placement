"""
Random policy for the rectangular environment where the components have pins.
"""

import random
import numpy as np
from environment.dummy_env_rectangular_pin import DummyPlacementEnvRectPin
...
def random_policy(valid_actions: list) -> Tuple[int, int]:
    ...
    Returns:
        tuple([int,int]): The randomly sampled action.
    """
...
def simulate(env: DummyPlacementEnvRectPin, policy, n_episodes: int = 1000) -> list:
